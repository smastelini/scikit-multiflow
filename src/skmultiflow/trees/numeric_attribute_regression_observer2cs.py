...
class NumericAttributeRegressionObserver2CS(NumericAttributeClassObserverBinaryTree):
    ...
    class Node:
        ...
        def __init__(self, val, label):
            ...
            try:
                ...
                self._left_statistics[3] += val * label
            except KeyError:
                self._left_statistics[0] = 1
                self._left_statistics[1] = label
                self._left_statistics[2] = label * label
        ...
        def insert_value(self, val, label):
            if val == self._cut_point:
                ...
                if self._left is None:
                    self._left = NumericAttributeRegressionObserver2CS.Node(val, label)
                else:
                ...
                try:
                    ...
                    self._right_statistics[3] += val * label
                except KeyError:
                    self._right_statistics[0] = 1
                    self._right_statistics[1] = label
                    self._right_statistics[2] = label * label
                ...
                if self._right is None:
                    self._right = NumericAttributeRegressionObserver2CS.Node(val, label)
                else:
    ...
    def __init__(self):
        ...
        self._sum_xy_total_left = 0.0
        self._sum_xy_total_right = 0.0
    ...
    def observe_attribute_class(self, att_val, class_val, weight):
        ...
        if att_val is None:
            ...
            if self._root is None:
                self._root = NumericAttributeRegressionObserver2CS.Node(att_val, class_val)
            else:
    ...
    def get_best_evaluated_split_suggestion(self, criterion, pre_split_dist, att_idx, binary_only):
        ...
        self._sum_xy_total_left = 0.0
        self._sum_xy_total_right = pre_split_dist[3]
        self._count_left_total = 0.0
    ...
    def search_for_best_split_option(self, current_node, current_best_option, criterion, att_idx):
        ...
        self._sum_xy_total_left += current_node._left_statistics[3]
        self._sum_xy_total_right -= current_node._left_statistics[3]
        ...
        pre_split_dist = [(self._count_left_total + self._count_right_total),
                          ...
                          (self._sum_xy_total_left + self._sum_xy_total_right)]
        ...
        self._sum_xy_total_left -= current_node._left_statistics.get(3)
        self._sum_xy_total_right += current_node._left_statistics.get(3)
    ...
    def remove_bad_split_nodes(self, criterion, current_node, last_check_ratio, last_check_sdr, last_check_e):
        ...
        if is_bad:
            left_stat = [current_node._left_statistics[0], current_node._left_statistics[1],
                         current_node._left_statistics[2], current_node._left_statistics[3]]
            right_stat = [current_node._right_statistics[0], current_node._right_statistics[1],
                          current_node._right_statistics[2], current_node._right_statistics[3]]
            ...
            pre_split_dist = [(current_node._left_statistics.get(0) + current_node._right_statistics.get(0)),
                               ...
                               (current_node._left_statistics.get(3) + current_node._right_statistics.get(3))]
            merit = criterion.get_merit_of_split(pre_split_dist, post_split_dists)
