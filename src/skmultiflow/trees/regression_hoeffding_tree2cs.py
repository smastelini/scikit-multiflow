...
class RegressionHoeffdingTree2CS(RegressorMixin, HoeffdingTree):
    ...
    """
    class CorrelationBasedActiveLearningNodeForRegression(HoeffdingTree.ActiveLearningNode):
    ...
    class InactiveLearningNodeForRegression(HoeffdingTree.InactiveLearningNode):
        ...
        def learn_from_instance(self, X, y, weight, ht):
            ...
            try:
                ...
                self._observed_class_distribution[3] += X * y * weight
            except KeyError:
                self._observed_class_distribution[0] = weight
                self._observed_class_distribution[1] = y * weight
                self._observed_class_distribution[2] = y * y * weight
    ...
    class ActiveLearningNodeForRegression(CorrelationBasedActiveLearningNodeForRegression):
    ...
    class LearningNodePerceptron(CorrelationBasedActiveLearningNodeForRegression):
